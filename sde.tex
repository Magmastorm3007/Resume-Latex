...
Full-Stack Software Developer with 1.5 years of experience in React, Node.js, AWS, and PySpark. Skilled in building scalable systems, designing automated data pipelines, and delivering production-grade applications in agile environments.Currently working with a leading American Insurance firm with large scale datasets, complex analytical workloads and highly secure environment.
\end{rSection}
